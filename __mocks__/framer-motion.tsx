...
function custom<Props>(Component: string | React.ComponentType<Props>, _customMotionComponentConfig: CustomMotionComponentConfig = {}): CustomDomComponent<Props> {
	...
	return React.forwardRef((props, ref) => {
		...
		// eslint-disable-next-line @typescript-eslint/ban-ts-comment
		// @ts-ignore
		return typeof Component === "string" ? <div ref={ref} {...regularProps} /> : <Component ref={ref} {...regularProps} />;
	});
}
